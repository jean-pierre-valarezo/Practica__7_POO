...
public class EliminarDisco extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Eliminar Disco"));
    ...
    private void bntEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntEliminarActionPerformed
        if (disco != null) {
        int option = JOptionPane.showConfirmDialog(this, "¿Está seguro de eliminar el disco?", "Confirmar eliminación", JOptionPane.YES_NO_OPTION);
        if (option == JOptionPane.YES_OPTION) {
            controladorCantante.eliminarDisco(cantanteTempo, disco.getCodigo());
            JOptionPane.showMessageDialog(this, "Disco eliminado exitosamente");
            limpiarCampos();
            txtCodigo4.setEnabled(false);
            txtAnioLanzamiento4.setEnabled(false);
            bntEliminar.setEnabled(false);
            bntBuscarDisco.setEnabled(false);
            txtNombreDisco4.setEnabled(false);
            disco = null; // Clear the current disco reference
        }
    } else {
        JOptionPane.showMessageDialog(this, "No se ha seleccionado ningún disco");
    }
